...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function loadComingSoon() {
    ...
    fetch('content/coming-soon/coming-soon.json')
  ...
  function renderCatatanGrid() {
    ...
    grid.querySelectorAll('.catatan-card').forEach(function(card) {
      ...
      card.addEventListener('click', function(e) {
        ...
        window.location.href = 'content/catatan/pages/editor.html?id=' + card.getAttribute('data-id');
      });
  ...
  if (btnTambah) {
    btnTambah.addEventListener('click', function() {
      ...
      saveNotes(notes);
      window.location.href = 'content/catatan/pages/editor.html?id=' + id;
    });
  }
  ...
  if (btnCariCeramah) {
    btnCariCeramah.addEventListener('click', function() {
      window.location.href = 'content/ceramah/pages/index-ceramah.html';
    });
  }
    ...
    grid.querySelectorAll('.cc-popup-item').forEach(function(item) {
      item.addEventListener('click', function(e) {
        ...
        if (action === 'edit') {
          ...
          window.location.href = 'content/ceramah/pages/baca.html';
