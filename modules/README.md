...
### C. Style
- Website ini dikembangkan menggunakan tablet (device layar lebar) tapi hendaknya lebih mengutamakan penggunaan HP (device layar kecil) karena banyaknya pengguna yang akan memakai HP (Mobile First)
